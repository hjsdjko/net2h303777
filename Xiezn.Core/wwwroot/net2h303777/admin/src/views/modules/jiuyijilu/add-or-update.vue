	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="就诊医院" prop="jiuzhenyiyuan">
					<el-input v-model="ruleForm.jiuzhenyiyuan" placeholder="就诊医院" clearable  :readonly="ro.jiuzhenyiyuan"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="就诊医院" prop="jiuzhenyiyuan">
					<el-input v-model="ruleForm.jiuzhenyiyuan" placeholder="就诊医院" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="疾病名称" prop="jibingmingcheng">
					<el-input v-model="ruleForm.jibingmingcheng" placeholder="疾病名称" clearable  :readonly="ro.jibingmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="疾病名称" prop="jibingmingcheng">
					<el-input v-model="ruleForm.jibingmingcheng" placeholder="疾病名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="诊断日期" prop="zhenduanriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.zhenduanriqi" label="诊断日期" prop="zhenduanriqi">
					<el-input v-model="ruleForm.zhenduanriqi" placeholder="诊断日期" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="病情描述" prop="bingqingmiaoshu">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.bingqingmiaoshu" label="病情描述" prop="bingqingmiaoshu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.bingqingmiaoshu}}</span>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zhenduanjieguo" label="诊断结果" prop="zhenduanjieguo">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zhenduanjieguo}}</span>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zhiliaofangan" label="治疗方案" prop="zhiliaofangan">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zhiliaofangan}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.canbaorenzhanghao!=''&&json.canbaorenzhanghao) || json.canbaorenzhanghao==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.canbaorenzhanghao = json.canbaorenzhanghao
						this.ro.canbaorenzhanghao = true;
					}
					if(((json.canbaorenxingming!=''&&json.canbaorenxingming) || json.canbaorenxingming==0) && this.$storage.get("role")!="管理员"){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `jiuyijilu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.jiuyijiluCrossAddOrUpdateFlag = false;
											this.parent.search();
