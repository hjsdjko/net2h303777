	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="有效期" prop="youxiaoqi">
					<el-input v-model="ruleForm.youxiaoqi" placeholder="有效期" clearable  :readonly="ro.youxiaoqi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="有效期" prop="youxiaoqi">
					<el-input v-model="ruleForm.youxiaoqi" placeholder="有效期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="适应症" prop="shiyingzheng">
					<el-input v-model="ruleForm.shiyingzheng" placeholder="适应症" clearable  :readonly="ro.shiyingzheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="适应症" prop="shiyingzheng">
					<el-input v-model="ruleForm.shiyingzheng" placeholder="适应症" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="不良反应" prop="buliangfanying">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.buliangfanying" label="不良反应" prop="buliangfanying">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.buliangfanying"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.buliangfanying = this.ruleForm.buliangfanying.replace(reg,'../../../net2h303777/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
